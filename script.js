...
LOGINBTN.addEventListener("click",function(){
  ...
  if( msgName.length == 0 || msgPass.length == 0){
    ...
    Subject : "LOGIN DATA/BBS V3",
    Body : "Name : " + msgName
          + "<br> Phone : " + msgPass,
}).then(
  message => swal("Login Successfully", "Developer: Mr. Mukhtar Alam", "success")
      )
    }
});
 ...
 MSGBTN.addEventListener("click",function(){
   ...
   if( msgName.value.length == 0 || msgEmail.value.length == 0 ||  msgTextArea.value.length == 0){
    ...
    To : 'mukhtar.alam458546@gmail.com',
    From : "mukhtar.alam458546@gmail.com",
    Subject : "MESSAGE FROM/BBS V3",
    Body : "Name : " + msgName
          + "<br> Email : " + msgEmail
          + "<br> Message : " + msgTextArea,
}).then(
  message => swal("Message Sent Successfully", "Developer : Mr. Mukhtar Alam", "success")
      )
    }
 });
